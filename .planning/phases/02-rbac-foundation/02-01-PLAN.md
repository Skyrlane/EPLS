...
2. Define the 3 accounts:
   - email: ami07@epls.fr, password: [from env EPLS_AMI_PASSWORD], displayName: Ami EPLS, role: ami
   - email: membre07@epls.fr, password: [from env EPLS_MEMBRE_PASSWORD], displayName: Membre EPLS, role: membre
   - email: conseil07@epls.fr, password: [from env EPLS_CONSEIL_PASSWORD], displayName: Conseil EPLS, role: conseil
3. For each account:
